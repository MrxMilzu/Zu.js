/*
 * Wellcome
 * Jangan Lupa Sabreknya
 * Gak Sabrek Gue Kejar Lu aampe Ke neraka
*/
const
{
WAConnection,
...
//Module Export
module.exports = Zu = async (Zu, mek, _welkom) => {
try {
...
const botNumber = Zu.user.jid
const ownerNumber = [`${ownernumber}@s.whatsapp.net`, `${ownernumber2}@s.whatsapp.net`]
const isGroup = from.endsWith('@g.us')
const isQuotedReply = type === 'extendedTextMessage' && content.includes('Message')
let sender = isGroup ? mek.participant : mek.key.remoteJid
let senderr = mek.key.fromMe ? Zu.user.jid : mek.key.remoteJid.endsWith('@g.us') ? mek.participant : mek.key.remoteJid
const groupMetadata = isGroup ? await Zu.groupMetadata(from) : ''
...
const conts = mek.key.fromMe ? Zu.user.jid : Zu.contacts[sender] || { notify: jid.replace(/@.+/, '') }
const pushname = mek.key.fromMe ? Zu.user.name : conts.notify || conts.vname || conts.name || '-'
...
let bio_nya = await Zu.getStatus(sender)
try {
...
Badmin: '*Bot Saya Harus Menjadi Admin Untuk Menggunakan Fitur*', 
}
}
const isUrl = (url) => {
...
Zu.sendMessage(to, media, type, { quoted: ftrol, mimetype: mime, caption: text,contextInfo: {"mentionedJid": mids}})
...
_healt.push(obj)
fs.writeFileSync('./lib/rpg/healt.json', JSON.stringify(_healt))
Zu.sendMessage(from, `${healthCounts}`, text, { quoted : mek})
}
}
//Ucapan & Dll
...
const daftar2 = '```Klik Tombol Di Bawah Untuk Register```'
...
Zu.sendMessage(to, media, MessageType.sticker,{quoted:mek})
...
Zu.sendMessage(from, buttonMessages, buttonsMessage, {
quoted: ftrol
})
}
...
media = file1
kma = doc1
yha = await Zu.prepareMessage(from, media, document, kma)
...
Zu.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
}
const sendButImage = async (from, context, fortext, img, but, mek) => {
jadinya = await Zu.prepareMessage(from, img, image)
buttonMessagesI = {
...
Zu.sendMessage(from, buttonMessagesI, buttonsMessage, {
quoted: ftrol,
})
}
async function sendButLocation(id, text1, desc1, gam1, but = [], options = {}) {
const buttonMessages = { locationMessage: { jpegThumbnail: gam1 }, contentText: text1, footerText: desc1, buttons: but, headerType: 6 }
return Zu.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
}
const sendButDocument = async(id, text1, desc1, media, doc1, but = [], options = {}) => {
kma = doc1
mhan = await Zu.prepareMessage(from, media, document, kma)
const buttonMessages = {
...
kma = vid1
mhan = await Zu.prepareMessage(from, kma, video)
const buttonMessages = {
...
var p = await Zu.getStatus(`${sender}`, MessageType.text)
ptod = "6285264641929@s.whatsapp.net"
stod = `${sender}`
dtod = 'ngetes'
uwu = '```'
stst = await Zu.getStatus(`${sender.split('@')[0]}@c.us`)
...
🏎️ _*Speed*_ : ${processsTime(mek.messageTimestamp.low, moment())}s
...
Zu.sendMessage(from, listMsg, MessageType.listMessage, {contextInfo: { mentionedJid: [sender]},quoted:mek})
break
case 'allmenu':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
if (isBanned) return reply('Kamu Sudah Di banned!')
...
💻 *Info Bot* 💻
👤 _*Admin Name*_ : ${ownername}
🤖 _*Nama Bot*_ : ${botname}
💻 _*Speed*_ : ${processsTime(mek.messageTimestamp.low, moment())}s
📱 _*Runtime*_ : ${runtime(process.uptime())}
🗃 _*Status*_ : ${public? `Public Mode`:`Self Mode`}

👤 *Information Anda* 👤
🌱 _*Name Anda*_ : ${pushname}
🏷 _*Bio Anda*_ : ${p.status==undefined?`Not Found`:p.status}
📱 _*Nomor HP*_ : @${sender.split('@')[0]}
...
Zu.sendMessage(from, buff, image, {quoted: ftrol, caption: `Succes By : ${ownername}`})
} else {
...
reply(`Itu Nomor Owner Gue Jangan Jahil Yah`)
break
case 'creator':
...
await Zu.sendMessage(from, buMess, MessageType.buttonsMessage, {quoted: mek})
break
case 'self':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner) 
...
for (let _ of anu100) {
Zu.sendMessage(_.jid, bc100, image, {quoted: ftrol, caption: `*「 PESAN SIARAN BOT 」*\n\n${body.slice(4)}`})
}
reply('Suksess broadcast')
} else {
for (let _ of anu100) {
Zu.sendMessage(_.jid, 
...
Zu.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: mek })
break
case 'setnamabot':{
if (!isOwner && !mek.key.fromMe) return reply(mess.only.owner) 
if (args.length < 1) return reply(`Kirim perintah ${command} nama\n\nContoh : ${command} RyuuSih`)
Zu.updateProfileName(q)
...
*DATA INFO PENTING !!*.
1. Data Whatsapp Anda Akan Kami Simpan Di Tools Kami Selama BOT Kami Aktif.
2. Data Anda Akan Di Hapus Ketika BOT Sudah Offline/Masa Sewa Anda Sudah Berakir
3. Kami Tidak Menyimpan Gambar, Video, File, Audio, Dan Dokumen Yang Anda Kirim Ke WhatsApp
4. Kami Tidak Akan Pernah Meminta Anda Untuk Memberikan Informasi Pribadi
5. Jika Menemukan BUG/ERROR Silahkan Langsung Lapor Ke OWNER BOT! / Bisa Juga Ke [ wa.me/+625264641929 ]


*ATTENTION*❗
*KONSEKUENSI BILA MELANGGAR RULES*
- Bot Akan Memblokir Nomor Anda/Bot Tidak Akan Bereaksi apapun.
- Anda Tidak Akan Bisa Mengakses Bot Lagi Walaupun Anda Sudah Menyewanya.
- Mengeksploitasi Terhadap bot.
Sanksi: *PERMANENT BLOCK/KICK DARI GRUP*`
...
Zu.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: mek})
fs.unlinkSync(ran)
})
...
try {
encmedia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
media = await Zu.downloadAndSaveMediaMessage(encmedia)
ran = getRandom('.mp3')
exec(`ffmpeg -i ${media} -filter:a "atempo=0.7,asetrate=44100" ${ran}`, (err, stderr, stdout) => {
fs.unlinkSync(media)
if (err) return reply('Error!')
uhh = fs.readFileSync(ran)
Zu.sendMessage(from, uhh, audio, {mimetype: 'audio/mp4', ptt:true, quoted: mek,duration:999999999999})
fs.unlinkSync(ran)
})
} catch (e) {
reply(mess.error)
...
Zu.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', duration: cokmatane, ptt: true, quoted: mek})
fs.unlinkSync(media)
limitAdd(sender, limit)
break
case 'tupai':
...
if (err) return reply('Error!')
hah = fs.readFileSync(ran)
Zu.sendMessage(from, hah, audio, {mimetype: 'audio/mp4', ptt:true, quoted: mek,duration:99})
fs.unlinkSync(ran)
})
 } catch (e) {
reply(mess.error)
...
Zu.sendMessage(from, man, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'sound2':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
...
.on('end', function () {
console.log('Finish')
Zu.sendMessage(from, fs.readFileSync(ran), sticker, {quoted: mek})
fs.unlinkSync(media)
fs.unlinkSync(ran)
})
...
Zu.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: mek})
fs.unlinkSync(media)
...
Zu.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih'})
fs.unlinkSync(ran)
})
break
...
Zu.sendMessage(from, anu1, image, {quoted: mek }) //Senggaja Gw Pake Image Karna Kalo Sticker Gada Tulisannya
break
case 'attp':
if (!c) return reply(`Teks Nya Mana Kak?\nContoh :\n${prefix}attp Ryuuka Botz`)
buffer = await getBuffer(`https://api.xteam.xyz/attp?file&text=${c}`)
Zu.sendMessage(from, buffer, sticker, { quoted: mek })
break
...
Zu.sendMessage(from, resu, image, {caption:'Nih Kak Tinggal Jadikan Sticker', quoted: mek})
fs.unlinkSync(media)
} catch (e) {
console.log(e)
}
...
Zu.sendMessage(from, '*Pertanyaan :* '+apakah+'\n*Jawaban :* '+ kah, text, { quoted: mek })
break
...
Zu.sendMessage(from, '*Pertanyaan :* '+rate+'\n*Jawaban :* '+ te+'%', text, { quoted: mek })
break
case 'bisakah':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
Zu.sendMessage(from, '*Pertanyaan :* '+bisakah+'\n*Jawaban :* '+ keh, text, { quoted: mek })
break
case 'kapankah':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
Zu.sendMessage(from, '*Pertanyaan :* '+kapankah+'\n*Jawaban :* '+ koh, text, { quoted: mek })
break
case 'slot':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
...
Zu.sendMessage(from, truteh, image, { caption: '*Truth*\n\n'+ ttrth, quoted: mek })
break
case 'dare':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
...
Zu.sendMessage(from, buff, image, { caption: '*Dare*\n\n'+ der, quoted: mek })
break
case 'bagaimanakah':
if (isBanned) return reply('Kamu Sudah Di banned!')
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
...
Zu.sendMessage(from, 'Pertanyaan : *'+bagaimanakah+'*\n\nJawaban : '+ mana, text, { quoted: mek })
break
...
Zu.sendMessage(from, ini_buffer, image, { quoted: ftrol})
limitAdd(sender, limit)
break
...
Zu.sendMessage(from, goo, image, {quoted: ftrol, caption: `Success By : ${ownername}`})
limitAdd(sender, limit)
break
...
Zu.sendMessage(from, buffer, video, {quoted: ftrol})
.catch((err) => {
...
Zu.sendMessage(from, anu, image, {quoted: ftrol, caption: `Success By : ${ownername}`})
break
...
Zu.sendMessage(from, goo, image, {quoted: ftrol, caption: `*${huft.result.title}*\n\n*Author* 👤 : ${huft.result.author}`})
break
case 'artinama':
...
Zu.updateProfilePicture(from, media)
...
buffer = fs.readFileSync(ran)
Zu.updateProfilePicture(from, buffer)
fs.unlinkSync(ran)
})
} else {
...
if (!isBotGroupAdmins) return reply(`Jadikan Bot Sebagai Admin Group!`)
if (args.length == 0)return reply(`Penggunaan ${prefix + command} Ryuuka Support`)
Zu.groupUpdateDescription(from, q)
.then((res) => reply(jsonformat(res)))
.catch((err) => reply(jsonformat(err)))
break
...
.on('exit', () => {
Zu.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Lord. Jadilah siswa yang rajin ರ_ರ`})
...
.on('error', () => reply(mess.eror))
.on('exit', () => {
Zu.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Lord. Jadilah siswa yang rajin ರ_ರ`})
...
.on('error', () => reply(mess.eror))
.on('exit', () => {
Zu.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkiri.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Lord. Jadilah siswa yang rajin ರ_ರ`})
...
.on('error', () => reply(mess.eror))
.on('exit', () => {
Zu.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {thumbnail:Buffer.alloc(0),quoted: mek, caption: `Jangan Malas Lord. Jadilah siswa yang rajin ರ_ರ`})
...
Zu.sendMessage(from, ini_buffer, image, { quoted: mek, caption: 'Silahkan jawab soal berikut ini\n\nPetunjuk :'+clue+'\nWaktu : 30s' }).then(() => {
...
jawaban = anu.jawaban
pertanyaan = anu.soal
Zu.sendMessage(from, '```Tebak Kata```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
...
Zu.sendMessage(from, '```Tebak Lirik```\n\n• *Soal* :'+anu.result.question+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
...
Zu.sendMessage(from, '```Tebak Jenaka```\n\n• *Soal* :'+anu.result.pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
...
Zu.sendMessage(from, '```Tebak Kimia```\n\n• *Soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
...
Zu.sendMessage(from, '```Tebak Bendera```\n\n• *Bendera* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
...
Zu.sendMessage(from, '```Caklontong```\n\n• *soal* :'+pertanyaan+'\n• *Waktu :* 30s', text, { quoted: mek}).then(() => {
...
Zu.sendMessage(from, ytmp3, audio, {mimetype:"audio/mp4", quoted:mek})
limitAdd(sender, limit)
break
case 'ytmp4':
if (isLimit(sender, isPrem, isOwner, limitCount, limit)) return reply(mess.limit) 
...
reply(`_*Data Di DapatKan!!*_\n\n💬 *Title* : ${anu.result.title}\n🖼 *Thumb* : ${anu.result.thumb}\n🖥 *Channel* : ${anu.result.channel}\n📅 *Publish* : ${anu.result.published}\n👁 *Viewers* : ${anu.result.views}\n\nAudio Akan Dikirim Beberapa Menit!`)
Zu.sendMessage(from, ytmp4, video, {caption:`Done By : ${botname}`, thumbnail:Buffer.alloc(0), quoted:mek})
limitAdd(sender, limit)
break
case 'tiktoknowm':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
...
Zu.sendMessage(from, buffer, video, {quoted: ftrol, caption: 'Succes By : © Ryuuka Botz'})
break
case 'tiktokwm':
if (!isUser) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol}) 
if (isBanned) return reply('Kamu Sudah Di banned!')
...
setTimeout( () => {
Zu.sendMessage(from, 'Berhasil Mendapatkan Ikan. . .', text) 
}, 5000) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, '🎣Meanarik kail. . .', text) 
}, 3000) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, '🎣Mulai memancing. . .', text) 
}, 1500) // 1000 = 1s,
...
setTimeout( () => {
Zu.sendMessage(from, `Awass`, text) 
}, 5000) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, `Tiba tiba ada ${sesuatu}`, text) 
}, 3000) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, `${pushname} sedang bertualang`, text) 
}, 1500) // 1000 = 1s,
...
setTimeout( () => {
Zu.sendMessage(from, '🚧 selesai menguli. . .🪙👷', text) 
}, 7000) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, '🚧 menemukan emas. . .⚒️🏔️️️', text) 
}, 4000) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, '🚧 mulai menambang. . .⚒️🏔️️', text) 
}, 1500) // 1000 = 1s,
setTimeout( () => {
Zu.sendMessage(from, mining, text, {quoted: mek}) 
}, 0) // 1000 = 1s,
break
case 'joinrpg':
if (!isGroup) return reply(mess.only.group)  
...
Zu.sendMessage(from, capt, text, {quoted: mek})
addInventori(sender)
...
Zu.sendMessage(from, ucapan, text, {quoted: ftrol, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
}
if (budy.startsWith('N')){
 ...
 naa = ky_ttt.filter(toek => !toek.id.includes(from)) 
 ky_ttt = naa
 Zu.sendMessage(from, `Yahh @${tty.player2.split('@')[0]} Menolak:(`,text,{quoted:mek,contextInfo:{mentionedJid:[tty.player2]}})
}
}
...
${ttt}`
Zu.sendMessage(from, ucapan1, text, {quoted: ftrol, contextInfo:{mentionedJid: [tty.player1]}})
naa = ky_ttt.filter(hhg => !hhg.id.includes(from))
return ky_ttt = naa
}
...
${ttt}`
Zu.sendMessage(from, ucapan1, text, {quoted:mek, contextInfo:{mentionedJid: [tty.player2]}})
naa = ky_ttt.filter(hhg => !hhg.id.includes(from))
return ky_ttt = naa
}
